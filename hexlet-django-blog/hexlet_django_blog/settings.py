"""Настройки Django для проекта hexlet_django_blog.

Сгенерировано командой 'django-admin startproject' с использованием Django 6.0.5.
...
SECRET_KEY = 'django-insecure-6)+ix#xk*gj^iwus_nx7j(jhna4sr6vtiqn128b%n3)k+xmp*6'
